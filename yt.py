...
def call_gemini(prompt):
    # Active Gemini Models list with auto-fallback
    ...
    for model in models:
        ...
        try:
            ...
            print(f"⚠️ Gemini API Model {model} error: {e}")
...
def generate_dark_canvas_image(title_text, filename="background.png"):
    # High-quality dark aesthetic cinematic canvas
